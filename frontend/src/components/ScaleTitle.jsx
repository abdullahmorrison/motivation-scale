...
var ScaleTitle = function (_a) {
    ...
    react_1.useEffect(function () {
        var fetchTitle = function () { return __awaiter(void 0, void 0, void 0, function () {
            var response, data;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, fetch('/scales/' + scaleID)];
                    case 1:
                        response = _a.sent();
    ...
    var handleTitleChange = function (event) { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
    ...
    return (<div className="scale__header__container">
            {displayH1 === true
            ? <h1>{title}</h1>
